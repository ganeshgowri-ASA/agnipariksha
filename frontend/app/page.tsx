...
// (TC + HF are the two flagship tests; everything else is one tap away.)
    ...
    <div className="min-h-screen bg-gray-950 text-gray-100 flex flex-col">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="flex-1 flex flex-col">
        ...
        >
          ...
          {/* "More" menu — only on narrow widths. */}
      ...
      {/* Mobile: AI lives in a bottom-sheet so it doesn't fight the tabs for screen real-estate. */}
      <button
        type="button"
