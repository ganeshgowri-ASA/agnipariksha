...
try:
    ...
    from .basic_check import router as basic_check_router
    ...
    from .api.scpi_routes import _enforce_basic_check_gate, router as scpi_router
    ...
    from basic_check import router as basic_check_router  # type: ignore[no-redef]
    ...
    from api.scpi_routes import _enforce_basic_check_gate, router as scpi_router  # type: ignore[no-redef]
